...
class Classifier:
    """A wrapper class for the Multi-layer Percentron classifier.

    This class provides a consistent interface that can be used with other
    classifier models.
    """

    model_name = "Multi-layer Percentron Classifier"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Construct a new Multi-layer Percentron classifier.
